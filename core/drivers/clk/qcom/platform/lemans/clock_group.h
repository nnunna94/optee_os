...
/* Full physical addresses; CBCR-to-CMD_RCGR distance is not architectural, don't derive one from the other. */
...
/* Wrapper-level gating clocks (core/core_2x/m_ahb/s_ahb): no RCG backs these. */
...
/* PLL branch-enable vote register and bits for the PLLs QUP SE RCGs source from; direct GCC write, not RPMh. */
